# -*- encoding: utf-8 -*-
# stub: wysiwyg-rails 2.0.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<font-awesome-rails>.freeze, [">= 4.4.0.0", "~> 4.4"])
    else
      s.add_dependency(%q<railties>.freeze, ["< 5.0", ">= 3.2"])
      s.add_dependency(%q<font-awesome-rails>.freeze, [">= 4.4.0.0", "~> 4.4"])
    end
  else
    s.add_dependency(%q<railties>.freeze, ["< 5.0", ">= 3.2"])
    s.add_dependency(%q<font-awesome-rails>.freeze, [">= 4.4.0.0", "~> 4.4"])
